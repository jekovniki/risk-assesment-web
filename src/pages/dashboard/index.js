                        ...
                        <Grid xs={12} md={8}>
                            {loading ? <Loader customColor="rgb(46, 136, 219)" /> :
                                <>
                                    ...
                                    <StandardBox>
                                        <PepBox>
                                            <PepImage src="https://upload.wikimedia.org/wikipedia/commons/3/3b/Delyan_Peevski_%2841NS%29.png" alt="Pep" />
                                            <PepContentBox>
                                                <TwoColumns>
                                                    <div>Delyan Slavchev Peevski</div>
                                                    <div>{arrowRight()}</div>
                                                </TwoColumns>
                                                <PepDataWrapper>
                                                    <PepDataBox>
                                                        <LabelBox>Date Of Birth</LabelBox>
                                                        <DataBox>27 July, 1980</DataBox>
                                                    </PepDataBox>
                                                    <PepDataBox>
                                                        <LabelBox>Place of Birth</LabelBox>
                                                        <DataBox>Sofia, Bulgaria</DataBox>
                                                    </PepDataBox>
                                                    <PepDataBox>
                                                        <LabelBox>Gender</LabelBox>
                                                        <DataBox>Male</DataBox>
                                                    </PepDataBox>
                                                    <PepDataBox>
                                                        <LabelBox>Citizenship</LabelBox>
                                                        <DataBox>Bulgarian</DataBox>
                                                    </PepDataBox>
                                                </PepDataWrapper>
                                            </PepContentBox>
                                        </PepBox>
